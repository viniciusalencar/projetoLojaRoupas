...
export class VendasService {
  ...
  */
  ...
  private endPoint : string = 'vendas';
  ...
  novo(vendas: any) {
    return this.http.post(env.apiUri + this.endPoint, vendas).toPromise();
  }
  ...
  atualizar(vendas: any) {
    return this.http.put(env.apiUri + this.endPoint, vendas).toPromise();
  }
