...
export class VendedorService {
  ...
  */
  ...
  private endPoint : string = 'vendedor';
  ...
  novo(vendedor: any) {
    return this.http.post(env.apiUri + this.endPoint, vendedor).toPromise();
  }
  ...
  atualizar(vendedor: any) {
    return this.http.put(env.apiUri + this.endPoint, vendedor).toPromise();
  }
